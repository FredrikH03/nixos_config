    ...
    firefox = {
      ...
      policies = {
        ...
        ExtensionSettings = {
          ...
          "{3754707b-1aa4-4c6f-96e7-5b1cdc1de5f9}" = {
            install_url = "https://addons.mozilla.org/firefox/downloads/latest/torn-tools/latest.xpi";
            installation_mode = "force_installed";
          };
        ...
        Preferences = { 
          ...
          # nevermind, does not work at the moment
          # TODO: fix this 
